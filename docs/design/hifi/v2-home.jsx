...
const { SB, Icon, KindIcon, HIFI_KINDS, HIFI_PAST, HIFI_UPCOMING, HIFI_TOTALS, V2Sidebar } = window;
...
const HM_ACCENT = SB.accent[HM_MODE], HM_ACCENT_FADED = SB.accent.faded[HM_MODE], HM_ACCENT_TEXT = SB.accent.text;
      ...
      <div style={{flex:1, overflow:'auto'}}>
        ...
        <div style={{
          ...
          <div style={{display:'flex', alignItems:'center', gap:8}}>
            {React.createElement(KindIcon[next.kind], {size:12, color:hmKind(next.kind)})}
            ...
            <span style={{
              ...
              padding:'2px 7px', border:`1px solid ${HM_ACCENT}`, letterSpacing:'.06em', textTransform:'uppercase',
              display:'inline-flex', alignItems:'center', gap:4,
            }}>
              <Icon.Check size={10} color={HM_ACCENT}/> tix
            </span>
          </div>
        ...
        <div style={{padding:'2px 20px 18px'}}>
          ...
          <div style={{
            ...
            fontFamily:SB.mono, fontSize:10.5, color:HM_ACCENT, letterSpacing:'.04em',
            display:'flex', alignItems:'center', gap:6, cursor:'pointer',
          }}>
            <span>all 4 upcoming</span>
            <Icon.ArrowRight size={11} color={HM_ACCENT}/>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{fontFamily:SB.mono, fontSize:10.5, color:HM_ACCENT, display:'flex', alignItems:'center', gap:6, cursor:'pointer'}}>
            all 87 <Icon.ArrowRight size={11} color={HM_ACCENT}/>
          </div>
        </div>
        <div>
          {HIFI_PAST.map((s,i)=>(
            <div key={s.id} style={{
              ...
              <div style={{minWidth:0}}>
                <div style={{
                  ...
                  {React.createElement(KindIcon[s.kind], {size:11, color:hmKind(s.kind)})}
        ...
        {[
          ...
          <div key={k} style={{flex:1, display:'flex', flexDirection:'column', alignItems:'center', gap:4}}>
            <div style={{
              ...
              background: cta?HM_ACCENT:'transparent',
              color: cta?HM_ACCENT_TEXT:(active?HM_ACCENT:HM_MUTED),
            ...
            <div style={{
              ...
              color: active?HM_ACCENT:HM_MUTED, fontWeight: active?500:400, textTransform:'lowercase',
            }}>{l}</div>
          </div>
        ))}
      </div>
...
const HW_ACCENT = SB.accent[HW_MODE], HW_ACCENT_TEXT = SB.accent.text;
        ...
        <div style={{
          ...
          <section>
            <div style={{display:'flex', alignItems:'baseline', gap:10, marginBottom:12}}>
              ...
              <div style={{flex:1}}/>
              <div style={{fontFamily:SB.mono, fontSize:10.5, color:HW_ACCENT, letterSpacing:'.04em', display:'flex', alignItems:'center', gap:6, cursor:'pointer'}}>
                see all 4 upcoming <Icon.ArrowRight size={11} color={HW_ACCENT}/>
              </div>
            </div>
              ...
              <div style={{minWidth:0}}>
                <div style={{display:'flex', alignItems:'center', gap:12, marginBottom:14}}>
                  <span style={{display:'inline-flex', alignItems:'center', gap:7,
                    ...
                    {React.createElement(KindIcon[next.kind], {size:13, color:hwKind(next.kind)})}
                    {HIFI_KINDS[next.kind].label}
                  </span>
                  <span style={{
                    fontFamily:SB.mono, fontSize:10.5, color:HW_INK,
                    padding:'3px 8px', border:`1px solid ${HW_ACCENT}`,
                    letterSpacing:'.06em', textTransform:'uppercase',
                    display:'inline-flex', alignItems:'center', gap:5,
                  }}>
                    <Icon.Check size={11} color={HW_ACCENT}/> Ticketed
                  </span>
                </div>
            ...
            <div style={{
              ...
              {then.map(u=>(
                <div key={u.id} style={{
                  ...
                  <div style={{display:'flex', alignItems:'center', justifyContent:'space-between'}}>
                    <span style={{display:'inline-flex', alignItems:'center', gap:6, fontFamily:SB.mono, fontSize:10, color:hwKind(u.kind), letterSpacing:'.1em', textTransform:'uppercase', fontWeight:500}}>
                      {React.createElement(KindIcon[u.kind], {size:11, color:hwKind(u.kind)})}
                      {HIFI_KINDS[u.kind].label}
                    </span>
                    <span style={{fontFamily:SB.mono, fontSize:10, color:u.hasTix?HW_ACCENT:HW_MUTED, letterSpacing:'.04em', display:'inline-flex', alignItems:'center', gap:4}}>
                      {u.hasTix ? <><Icon.SquareFilled size={8} color={HW_ACCENT}/>tix</> : <><Icon.Eye size={10} color={HW_MUTED}/>watching</>}
                    </span>
                  </div>
          ...
          <section>
            <div style={{display:'flex', alignItems:'baseline', gap:10, marginBottom:12}}>
              ...
              <div style={{flex:1}}/>
              <div style={{fontFamily:SB.mono, fontSize:10.5, color:HW_ACCENT, letterSpacing:'.04em', display:'flex', alignItems:'center', gap:6, cursor:'pointer'}}>
                open in Shows <Icon.ArrowRight size={11} color={HW_ACCENT}/>
              </div>
            </div>
              ...
              {HIFI_PAST.map((s,i)=>(
                <div key={s.id} style={{
                  ...
                  <div style={{
                    ...
                    {React.createElement(KindIcon[s.kind], {size:12, color:hwKind(s.kind)})}
                    {HIFI_KINDS[s.kind].label}
                  </div>
                  <div style={{minWidth:0}}>

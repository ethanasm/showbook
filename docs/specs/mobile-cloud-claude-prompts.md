...
- Plan: `docs/specs/mobile-m2-m6-plan.md` § M2
...
Read `docs/specs/mobile-m2-m6-plan.md § M3` for the sub-task graph.
...
Read `docs/specs/mobile-m2-m6-plan.md § M4`.
...
Read `docs/specs/mobile-m2-m6-plan.md § M5`.

...
window.SB = {
  ...
  // Per-kind accents — saturated, distinct from Claude orange
  kinds: {
    concert:  { label: 'Concert',  ink: '#FF5C2E', inkDark: '#FF7A4E' }, // signal orange
    theatre: { label: 'Theatre', ink: '#E6447A', inkDark: '#F27BA1' }, // hot pink
    comedy:   { label: 'Comedy',   ink: '#E0A91C', inkDark: '#F4C542' }, // marigold
    festival: { label: 'Festival', ink: '#2BB673', inkDark: '#3DDC97' }, // mint
  },

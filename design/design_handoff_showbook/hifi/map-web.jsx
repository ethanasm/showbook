    ...
    <div style={{
      ...
      <div style={{padding:'0 20px 24px'}}>
        <div style={{fontFamily:SB.sans, fontSize:19, fontWeight:600, color:MW_INK, letterSpacing:-0.5}}>
          showbook<span style={{color:MW_FAINT, fontWeight:400}}>/m</span>
        </div>
      ...
      <div style={{padding:'0 8px', flex:1}}>
        ...
        {Object.entries(HIFI_KINDS).map(([key, k])=>(
          <div key={key} style={{
            ...
            <span style={{
              width:9, height:9, borderRadius:999, background:mwKind(key),
            }}/>
      ...
      <div style={{padding:'14px 24px', borderBottom:`1px solid ${MW_RULE}`, display:'flex', gap:10, alignItems:'center'}}>
        ...
        {Object.entries(kindCounts).map(([k, c]) => (
          <div key={k} style={{
            ...
            <span style={{width:6, height:6, borderRadius:999, background:mwKind(k)}}/>
        ...
        {KINDS.map(({k, label}) => {
          ...
          return (
            <button key={k} onClick={()=>setKind(k)} style={{
              ...
              {k !== 'all' && <span style={{width:6, height:6, borderRadius:999, background:color}}/>}
              {label}
            </button>
          );
        })}

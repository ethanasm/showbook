...
const ROUTES: RouteSpec[] = [
  ...
  // Populated Home — exercises the hero show card, avatar-bearing rows,
  // and the personalised greeting + stat strip. Photo URLs are set so
  // the hero card and avatars try a fetch; the screenshot sandbox has
  // no outbound, so RemoteImage's kind-coloured monogram fallback
  // takes over visually. That's the same code path real users hit when
  // performer.imageUrl is missing, so the screenshot is representative.
  {
    name: '01b-home-populated',
    path: '/',
    ready: /Good (morning|afternoon|evening|Up late)/i,
    trpcStubs: {
      'shows.list': [
        {
          id: 'sb-screenshot-hero',
          ...
          showPerformers: [
            {
              showId: 'sb-screenshot-hero',
              performerId: 'sb-performer-tldp',
              role: 'headliner',
              sortOrder: 0,
              performer: {
                id: 'sb-performer-tldp',
                name: 'The Last Dinner Party',
                imageUrl: 'https://i.scdn.co/image/ab6761610000e5eb1234567890abcdef00000001',
              },
            },
          ],
        },
        {
          id: 'sb-screenshot-up-1',
          userId: 'pr-screenshots-user',
          kind: 'concert',
          state: 'ticketed',
          date: '2026-08-16',
          ...
          showPerformers: [
            {
              showId: 'sb-screenshot-up-1',
              performerId: 'sb-performer-pp',
              role: 'headliner',
              sortOrder: 0,
              performer: {
                id: 'sb-performer-pp',
                name: 'Passion Pit',
                imageUrl: 'https://i.scdn.co/image/ab6761610000e5eb1234567890abcdef00000002',
              },
            },
          ],
        },
        {
          id: 'sb-screenshot-up-2',
          userId: 'pr-screenshots-user',
          kind: 'concert',
          state: 'ticketed',
          date: '2026-09-17',
          ...
          showPerformers: [
            {
              showId: 'sb-screenshot-up-2',
              performerId: 'sb-performer-bl',
              role: 'headliner',
              sortOrder: 0,
              performer: {
                id: 'sb-performer-bl',
                name: 'Bleachers',
                imageUrl: 'https://i.scdn.co/image/ab6761610000e5eb1234567890abcdef00000003',
              },
            },
          ],
        },
        {
          id: 'sb-screenshot-past-1',
          userId: 'pr-screenshots-user',
          kind: 'concert',
          state: 'past',
          date: '2026-05-09',
          ...
          showPerformers: [
            {
              showId: 'sb-screenshot-past-1',
              performerId: 'sb-performer-nd',
              role: 'headliner',
              sortOrder: 0,
              performer: {
                id: 'sb-performer-nd',
                name: 'No Doubt',
                imageUrl: 'https://i.scdn.co/image/ab6761610000e5eb1234567890abcdef00000004',
              },
            },
          ],
        },
        {
          id: 'sb-screenshot-past-2',
          userId: 'pr-screenshots-user',
          kind: 'comedy',
          state: 'past',
          date: '2026-04-26',
          ...
          showPerformers: [
            {
              showId: 'sb-screenshot-past-2',
              performerId: 'sb-performer-jk',
              role: 'headliner',
              sortOrder: 0,
              performer: {
                id: 'sb-performer-jk',
                name: 'Jessica Kirson',
                imageUrl: 'https://i.scdn.co/image/ab6761610000e5eb1234567890abcdef00000005',
              },
            },
          ],
        },
